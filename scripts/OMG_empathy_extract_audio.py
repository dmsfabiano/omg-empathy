...
if __name__ == "__main__":
    ...
    #"D:\Neil_TFS\AR Emotion Research\OMG-Empathy-Challenge\data\Training\Videos\"
    path = "../data/Validation/Videos"

    # Path where the audios will be saved
    #savePath ="/data/audio/Validation/"
    #"D:\Neil_TFS\AR Emotion Research\OMG-Empathy-Challenge\data\audio\Training\"
    savePath = "../data/audio/Validation"
